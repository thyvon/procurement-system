...
- Known debt (don't copy): see root `AGENTS.md` → "Known inconsistencies" (inline validation in `ProductImportController` — no FormRequest, 422 without `errors`; `ProductRefController` returns raw snake_case models).
